...
namespace StaffManager.Service.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,FullName,Address,Phone,Image")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,FullName,Address,Phone,Image")] Staff staff)
        {
            if (ModelState.IsValid)
            {
